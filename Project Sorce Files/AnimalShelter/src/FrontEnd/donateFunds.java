...
public class donateFunds extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Donation Amount");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(amnt, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(dob, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel4.setBounds(160, 180, 368, 452);
        ...
        donate.setBounds(310, 650, 95, 45);
        ...
        formchart.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/form chart.PNG"))); // NOI18N
        ...
        formchart.setBounds(150, 150, 400, 570);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/donate.jpeg"))); // NOI18N
    ...
    private void jLabel1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseEntered
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/donate.jpeg")));
    ...
    private void donateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_donateActionPerformed
         ...
         if (ln.getText().length()<1 || HelperMethods.isAlpha(ln.getText()) == false)
      {
        ...
        if (amnt.getText().length() > 0 && HelperMethods.isNumber(amnt.getText()) == true)
        {
            if (Integer.parseInt(amnt.getText()) >= 500)
            {
                //get value
            }
            else
            {
                amnt.setText("Donation must be atleast 500");
                 errors++;
                amnt.setForeground(new java.awt.Color(255, 0, 0));
            }
        }
        
        else
        {
                if (amnt.getText().length() == 0)
                {
                    amnt.setText("please enter amount");
                }
                errors++;
                amnt.setForeground(new java.awt.Color(255, 0, 0));
        }
           ...
           try {
			...
			ResultSet r = stmt.executeQuery("SELECT * FROM person where cnic = '" + cnic.getText() + "'");
                        if (r.next())
                        {
                            ...
                            r = stmt.executeQuery("SELECT * FROM donator where person_id = '" + User + "'");
                            ...
                            if (r.next())
                            {
                                ...
                                donator = r.getString(1);
                                stmt.executeUpdate("update donator set amount = amount + " + amnt.getText() +  " where person_id = " + User);
                                JOptionPane.showMessageDialog(rootPane, "We had your record already. Your Amount is recieved. Thank you");
                            }
                            ...
                            else
                            {
                                ...
                                stmt.executeUpdate("insert into donator (person_id, amount) values (" + donator + "," + amnt.getText() + ")");
                                
                                JOptionPane.showMessageDialog(rootPane, "Your Amount is recieved. Thank you");
                            }
                        ...
                        else
                        {
                            ...
                            String [] data = {fn.getText(),ln.getText(),agee+"",dob1,(gndr.getSelectedIndex()+1)+"",cnic.getText(),em.getText(),adrs.getText(),(cty.getSelectedIndex()+1)+"" ,mn.getText() , amnt.getText()};
                            ...
                            stmt.executeUpdate("insert into donator (person_id, amount) values (" + prsnId + "," + data[10] + ")");
    ...
    private void amntMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_amntMouseClicked
        ...
        amnt.setText("");
        amnt.setForeground(new java.awt.Color(0, 0, 0));
