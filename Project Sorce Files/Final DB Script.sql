...
CREATE TABLE IF NOT EXISTS `mydb`.`Medical_report` (
  ...
  INDEX `fk_animal_has_disease_animal1_idx` (`collar_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`animal_has_adopter` (
  ...
  PRIMARY KEY (`collar_id`, `adopter_id`),
  INDEX `fk_animal_has_adopter_adopter1_idx` (`adopter_id` ASC) ,
  INDEX `fk_animal_has_adopter_animal1_idx` (`collar_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`animal_has_dropper` (
  ...
  `date` VARCHAR(45) NULL,
  PRIMARY KEY (`collar_id`, `dropper_id`),
  INDEX `fk_animal_has_dropper_dropper1_idx` (`dropper_id` ASC) ,
  INDEX `fk_animal_has_dropper_animal1_idx` (`collar_id` ASC) ,
...
-- -----------------------------------------------------
-- Table `mydb`.`reunited_animal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`reunited_animal` (
  `animal_collar_id` INT NOT NULL,
  `person_id` INT NOT NULL,
  PRIMARY KEY (`animal_collar_id`, `person_id`),
  INDEX `fk_reunited_animal_Owner1_idx` (`person_id` ASC) ,
  CONSTRAINT `fk_reunited_animal_animal1`
    FOREIGN KEY (`animal_collar_id`)
    REFERENCES `mydb`.`animal` (`collar_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_reunited_animal_Owner1`
    FOREIGN KEY (`person_id`)
...
-- -----------------------------------------------------
-- Table `mydb`.`Owner_claims_animal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Owner_claims_animal` (
  `person_id` INT NOT NULL,
  `animal_collar_id` INT NOT NULL,
  PRIMARY KEY (`person_id`, `animal_collar_id`),
  INDEX `fk_Owner_has_animal_animal1_idx` (`animal_collar_id` ASC) ,
  INDEX `fk_Owner_has_animal_Owner1_idx` (`person_id` ASC) ,
...
-- -----------------------------------------------------
-- Table `mydb`.`adopter_wants_animal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`adopter_wants_animal` (
  `adopter_id` INT NOT NULL,
  `animal_collar_id` INT NOT NULL,
  PRIMARY KEY (`adopter_id`, `animal_collar_id`),
  INDEX `fk_adopter_has_animal_animal1_idx` (`animal_collar_id` ASC) ,
  INDEX `fk_adopter_has_animal_adopter1_idx` (`adopter_id` ASC) ,
  CONSTRAINT `fk_adopter_has_animal_adopter1`
    FOREIGN KEY (`adopter_id`)
    REFERENCES `mydb`.`adopter` (`person_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_adopter_has_animal_animal1`
    FOREIGN KEY (`animal_collar_id`)
    REFERENCES `mydb`.`animal` (`collar_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
